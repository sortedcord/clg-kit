...
function DayCell({
  ...
  disabled: boolean;
  today: boolean;
  marker: 'none' | 'success' | 'warning' | 'danger' | 'neutral';
  onPress: () => void;
}) {
  ...
  return (
    <Pressable
      ...
      <Animated.View style={[styles.day, selected && styles.selected, disabled && styles.disabled, animStyle]}>
...
const styles = StyleSheet.create({
  ...
  dayPressable: { flex: 1 },
  day: { minHeight: 64, alignItems: 'center', justifyContent: 'center', borderRadius: radius.control, borderCurve: 'continuous', paddingVertical: spacing[2] },
